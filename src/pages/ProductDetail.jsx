    ...
    <main className="pd">
      ...
      <div className="pd-buybar" ref={buybarRef}>
        ...
        <span className="pd-buy-bubble" aria-hidden="true">
          오직 <b className="pd-buy-bubble-hl">카카오</b>
          
          <b className="pd-buy-bubble-hl">선물하기</b><svg className="pd-buy-bubble-icon" viewBox="0 0 500 500" role="img" aria-hidden="true">
            <path
              fill="currentColor"
