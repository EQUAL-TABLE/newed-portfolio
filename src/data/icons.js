...
export const icons = [
  { id: 'icon-1', description: 'BEST', img: deep_package, to:"/", kind: 'best' },
  { id: 'icon-2', description: '카카오 선물하기', img: bright_package, to:"https://gift.kakao.com/brand/20130", kind: 'shop' },
