...
export default function Hero() {
  ...
  return (
    <div className="hero" id="hero">
      <h1 className="sr-only">뉴드 NEWED — 한 모금에 선명한 향과 맛, 스페셜티 드립백, 입 안에 퍼지는 선명한 즐거움, 즐거운 순간을 두 배로 더 즐겁게, 한계를 넘어선 디카페인 커피</h1>
      <p className="sr-only">
        즐거운 순간을 두 배로 더 즐겁게,
        사랑하는 사람의 오늘이 조금 더 즐거울 수 있는 한 모금,
        뻔한 선물 말고 받는 순간 기분 좋아지는 선명한 즐거움,
        말보다 오래 기억될 수 있도록 마음을 전하는 가장 맛있는 방법
      </p>
      <div
