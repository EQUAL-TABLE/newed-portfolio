  ...
  return (
    ...
    >
      {/*
        ...
        lg(1024px) 이상에서는 비율 1200:800 (aspect-[3/2]), 그 미만에서는 400:600 (aspect-[2/3])으로 나누어 비율을 할당합니다.
        JS 감지 없이 순수 CSS 브레이크포인트(lg)로 전환하여 초기 렌더 깜빡임을 제거했습니다.
      */}
      <div
        className="w-full relative overflow-hidden aspect-[2/3] lg:aspect-[3/2]"
        id="full-image-container"
      >
        {/* 이미지 아트디렉션: lg(1024px) 이상에서 가로형 고해상 이미지, 미만에서는 세로형 모바일 이미지로 CSS-only 스왑 */}
        <picture>
          <source
