export default function Footer() {
  return (
    <footer
      ...
      className="bg-[#1A1A1A] py-6 md:py-8 xl:py-[40px] px-4 sm:px-8 md:px-16 xl:px-[100px] w-full border-t border-black/20 select-none"
      id="brand-footer"
    >
      <div className="w-full max-w-[1980px] mx-auto flex items-center justify-center" id="footer-content-container">
        ...
        <p
          className="text-white/85 text-xs sm:text-base md:text-lg xl:text-[25px] xl:leading-[35px] font-sans uppercase font-normal text-center"
